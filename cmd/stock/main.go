...
func main() {
	mysqlDSN := getEnv("MYSQL_DSN", "root:root@tcp(127.0.0.1:3306)/marketing_stock?charset=utf8mb4&parseTime=True&loc=Local")
	...
	server := stockserver.NewServer(svc)

	fmt.Println("Stock service starting...")
