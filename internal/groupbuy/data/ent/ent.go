...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			groupbuyactivity.Table: groupbuyactivity.ValidColumn,
			groupbuydiscount.Table: groupbuydiscount.ValidColumn,
			groupbuyorder.Table:    groupbuyorder.ValidColumn,
			groupbuyteam.Table:     groupbuyteam.ValidColumn,
