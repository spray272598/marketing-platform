...
type Data struct {
	...
	Stock         *Data_Stock            `protobuf:"bytes,4,opt,name=stock,proto3" json:"stock,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Data_Stock) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Data_Stock) ProtoMessage() {}

func (x *Data_Stock) ProtoReflect() protoreflect.Message {
	mi := &file_internal_conf_conf_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Data_Stock.ProtoReflect.Descriptor instead.
func (*Data_Stock) Descriptor() ([]byte, []int) {
...
const file_internal_conf_conf_proto_rawDesc = "" +
	"\n" +
	"\x18internal/conf/conf.proto\x12\rmarketing.api\x1a\x1egoogle/protobuf/duration.proto\"c\n" +
	"\tBootstrap\x12-\n" +
	"\x06server\x18\x01 \x01(\v2\x15.marketing.api.ServerR\x06server\x12'\n" +
	"\x04data\x18\x02 \x01(\v2\x13.marketing.api.DataR\x04data\"\xbe\x02\n" +
	"\x06Server\x12.\n" +
	"\x04http\x18\x01 \x01(\v2\x1a.marketing.api.Server.HTTPR\x04http\x12.\n" +
	"\x04grpc\x18\x02 \x01(\v2\x1a.marketing.api.Server.GRPCR\x04grpc\x1ai\n" +
	"\x04HTTP\x12\x18\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xec\x04\n" +
	"\x04Data\x128\n" +
	"\bdatabase\x18\x01 \x01(\v2\x1c.marketing.api.Data.DatabaseR\bdatabase\x12/\n" +
	"\x05redis\x18\x02 \x01(\v2\x19.marketing.api.Data.RedisR\x05redis\x128\n" +
	"\brabbitmq\x18\x03 \x01(\v2\x1c.marketing.api.Data.RabbitMQR\brabbitmq\x12/\n" +
	"\x05stock\x18\x04 \x01(\v2\x19.marketing.api.Data.StockR\x05stock\x1as\n" +
	"\bDatabase\x12\x16\n" +
	"\x06driver\x18\x01 \x01(\tR\x06driver\x12\x16\n" +
	"\x06source\x18\x02 \x01(\tR\x06source\x12\x14\n" +
	"\x05debug\x18\x03 \x01(\bR\x05debug\x12!\n" +
	"\fauto_migrate\x18\x04 \x01(\bR\vautoMigrate\x1a\xdf\x01\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	...
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x1a\x1c\n" +
	"\bRabbitMQ\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x1a\x19\n" +
	"\x05Stock\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03urlB2Z0github.com/marketing-platform/internal/conf;confb\x06proto3"
...
var file_internal_conf_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),           // 0: marketing.api.Bootstrap
	(*Server)(nil),              // 1: marketing.api.Server
	(*Data)(nil),                // 2: marketing.api.Data
	(*Server_HTTP)(nil),         // 3: marketing.api.Server.HTTP
	(*Server_GRPC)(nil),         // 4: marketing.api.Server.GRPC
	(*Data_Database)(nil),       // 5: marketing.api.Data.Database
	(*Data_Redis)(nil),          // 6: marketing.api.Data.Redis
	(*Data_RabbitMQ)(nil),       // 7: marketing.api.Data.RabbitMQ
	(*Data_Stock)(nil),          // 8: marketing.api.Data.Stock
	(*durationpb.Duration)(nil), // 9: google.protobuf.Duration
}
var file_internal_conf_conf_proto_depIdxs = []int32{
	1,  // 0: marketing.api.Bootstrap.server:type_name -> marketing.api.Server
	2,  // 1: marketing.api.Bootstrap.data:type_name -> marketing.api.Data
	3,  // 2: marketing.api.Server.http:type_name -> marketing.api.Server.HTTP
	4,  // 3: marketing.api.Server.grpc:type_name -> marketing.api.Server.GRPC
	5,  // 4: marketing.api.Data.database:type_name -> marketing.api.Data.Database
	6,  // 5: marketing.api.Data.redis:type_name -> marketing.api.Data.Redis
	7,  // 6: marketing.api.Data.rabbitmq:type_name -> marketing.api.Data.RabbitMQ
	8,  // 7: marketing.api.Data.stock:type_name -> marketing.api.Data.Stock
	9,  // 8: marketing.api.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	9,  // 9: marketing.api.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	9,  // 10: marketing.api.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	9,  // 11: marketing.api.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
